...
public class ApptRandomTest {
	...
	public void mytest() throws Throwable	{
		System.out.println("Beginning my test");
		long randomseed = 10;
		Random random = new Random(randomseed);
		int startHour;
		int startDay;
		...
		for(int i = 0; i < 200; i++)
		{
			startHour = ValuesGenerator.getRandomIntBetween(random,-24,48);
			startDay = ValuesGenerator.getRandomIntBetween(random,-14,45);
		...
		System.out.println("Ending my test");
	}
